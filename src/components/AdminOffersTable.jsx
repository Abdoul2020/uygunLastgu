...
import {
    ...
    Paper, Checkbox, IconButton, InputAdornment, Tooltip, FormControlLabel, Switch, ButtonGroup, Grid, TextField
} from '@mui/material';
...
export default function EnhancedTable() {
    const { offers } = useSelector(state => state.adminSlice);
            ...
            <Paper sx={{ width: '100%', mb: 2 }}>
                ...
                <TableContainer>
                    ...
                    >
                        ...
                        />
                        <TableBody>
                            {stableSort((filterRows.length == offers.length ? offers : filterRows), getComparator(order, orderBy))
                ...
                <TablePagination
                    ...
                    component="div"
                    count={(filterRows.length == offers.length ? offers : filterRows).length}
