            ...
            <div className="hidden lg:flex w-full h-full items-center justify-between">
                ...
                <div className="flex items-center gap-8 ">
                    ...
                    <motion.ul
                        ...
                        <Link to={"/adminuser"} className='text-base text-white hover:text-zinc-50 duration-100 transition-all ease-in-out cursor-pointer'><FaUserAlt className='ml-8 ' /> Kullanıcılar</Link>
                    </motion.ul>
                </div>
            </div>
